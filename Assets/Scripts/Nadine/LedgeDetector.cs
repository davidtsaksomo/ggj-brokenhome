...
public class LedgeDetector : MonoBehaviour
{
    ...
    public bool DetectLedge(PlayerController player)
    {
    ...
    void OnDrawGizmos()
    {
        ...
        float distance = player.facingRight ? raycastDistance : raycastDistance * -1;
        ...
        Vector2 center = player.facingRight ? new Vector2(transform.position.x + col.offset.x, transform.position.y + col.offset.y) 
